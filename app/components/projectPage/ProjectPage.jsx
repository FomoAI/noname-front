...
async function get_allowance_sum() {
  const address_nft= '0x0faF6df7054946141266420b43783387A78d82A9';
  ...
  const allowance_sum = await contract_nft.allowance(window.ethereum.selectedAddress,'0xDcc5e641f73a60d6AD996FB916D24b88c920a0f5');
...
async function set_allowance_for_mint(sum,quantity) {
  ...
  if (true){
    try {
        kala = await daiContractWithSigner.approve('0xDcc5e641f73a60d6AD996FB916D24b88c920a0f5',ethers.BigNumber.from(sum_last));
      } catch (err) {
...
async function provide_for_mint(sum,quantity) {
  ...
  try {
      await daiContractWithSigner_sale.buy_nft_presale(quantity,"0xC03870eaeE4661610179280fDf6cbda4B81D4A82")
    } catch (err) {
